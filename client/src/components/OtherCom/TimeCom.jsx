...
const TimeCom = () => {
    ...
    const AfternoonPeak = (hours === 15 && minutes >= 30) || (hours > 5 && hours < 21);
    return (
            ...
            <center>
                {
                    (() => {
                        ...
                        if (MorningPeak) {
                            return <div className="bg-red-500 py-4 px-8 rounded-lg">
                        ...
                        return <div className="bg-green-500 py-4 px-8 rounded-lg">
                            <h1 className="text-white font-semibold">{formattedDate}</h1>
                        </div>;
                    })()
                }
                ...
                <table className=" w-full mt-4">
                    ...
                    <tbody className="text-white">
                        <tr className="h-12 border-b border-white">
                            ...
                            <th className="font-seibold text-red-500">Morning Peak Hours</th>
                        </tr>
                        <tr className="h-12 border-b border-white">
                            <th>9.00 AM - 4.30 AM</th>
                            <th className="font-seibold text-green-500">OFF Peak Hours</th>
                        </tr>
                        <tr className="h-12 border-b border-white">
                            <th>4.30 PM - 9.00M</th>
                            <th className="font-seibold text-red-500">Afternoon Peak Hours</th>
                        </tr>
                        <tr className="h-12 border-b border-white">
